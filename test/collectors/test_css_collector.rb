...
class TestCSSCollector < Test::Unit::TestCase
  ...
  def test_start_selector
    ...
    expected = ['body','p','a:link','a:visited','a:hover','a:active','div.message','.info','.info.message','em','.ampersand','.info','.message', '#call_to_action', '.info', '.arbitary_class', '.not_in_class']
